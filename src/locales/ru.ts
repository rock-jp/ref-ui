...
const ru = {
  ...
  remove_watchlist: 'Удалить список отслеживания',
  ...
  protocol_projected_revenue_tip:
    'Это число соответствует совокупному доходу от комиссионных за трейдинг для держателей xREF. Она равна 75% от общего дохода комиссионных сборов платформы. Она будет отличаться от фактической суммы выкупа токенов REF из-за колебания цены.',
